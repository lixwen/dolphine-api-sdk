...
/**
 * This is a model class for Db2DataSourceParamDTO type.
 */
@JsonTypeInfo(
        use = JsonTypeInfo.Id.NAME,
        include = JsonTypeInfo.As.EXISTING_PROPERTY,
        property = "type",
        defaultImpl = Db2DataSourceParamDTO.class,
        visible = true)
@JsonInclude(Include.ALWAYS)
public class Db2DataSourceParamDTO
     ...
     * Default constructor.
     */
    public Db2DataSourceParamDTO() {
        super();
        setType("Db2DataSourceParamDTO");
    }
    ...
    /**
     * Converts this Db2DataSourceParamDTO into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Db2DataSourceParamDTO [" + "database=" + database + ", host=" + host + ", id=" + id
    ...
    /**
     * Builds a new {@link Db2DataSourceParamDTO.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Db2DataSourceParamDTO.Builder} object
     */
    public Builder toDb2DataSourceParamDTOBuilder() {
    ...
    /**
     * Class to build instances of {@link Db2DataSourceParamDTO}.
     */
    public static class Builder {
        ...
        private String password;
        private Integer port;
        private String type = "Db2DataSourceParamDTO";
        private String userName;
        private String database;
        private String host;
        private Integer id;
        ...
        private String password;
        private Integer port;
        private TypeEnum type = "Db2DataSourceParamDTO";
        private String userName;
        ...
        /**
         * Builds a new {@link Db2DataSourceParamDTO} object using the set fields.
         * @return {@link Db2DataSourceParamDTO}
         */
        public Db2DataSourceParamDTO build() {
            return new Db2DataSourceParamDTO(database, host, id, name, note, other, password, port,
                    type, userName, database, host, id, name, note, other, password, port, type,
                    userName);
        }
    }
}
