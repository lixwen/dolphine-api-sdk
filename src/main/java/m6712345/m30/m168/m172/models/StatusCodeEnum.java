...
public enum StatusCodeEnum {
    ...
    private static TreeMap<String, StatusCodeEnum> valueMap = new TreeMap<>();
    ...
    public static StatusCodeEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of StatusCodeEnum values to list of string values.
     * @param toConvert The list of StatusCodeEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<StatusCodeEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (StatusCodeEnum enumValue : toConvert) {
